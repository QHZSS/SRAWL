...
def annotate(sentence, lower=True):
    global client
    if client is None:
        client = CoreNLPClient(endpoint="http://localhost:9001",annotators=['ssplit','tokenize'],start_server=False)
    words, gloss, after = [], [], []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--split', default='train', help='comma=separated list of splits to process')
